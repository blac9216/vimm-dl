...
- Tabs: Library (beta flag, default when on), Downloads, Jobs, Metrics (Jobs + Metrics always visible), Sync (beta flag), Events (developer flag), Import (beta flag), Settings
